 ...
 */
public class FixationActivity extends SwipeActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fixation_activity);

        fixation = getIntent().getParcelableExtra("Fixation");

        baner_web_view = $(R.id.baner_web_view);
        title_id = $(R.id.title_id);
        title_id.setVisibility(View.VISIBLE);
        title_id.setText(fixation.title);
        ...
        //加载需要显示的网页
        webView.loadUrl(fixation.moreUrl);
        //设置Web视图
