 ...
 */
public class FloorsAdapter extends SimpleBaseAdapter<FloorsEntity> {

    public FloorsAdapter(Context context, List<FloorsEntity> list) {
        super(context, list);
        isCache = true;
    }
    ...
    public View getItemView(int position, View convertView, ViewHolder holder) {
        FloorsEntity tag = (FloorsEntity)getItem(position);
        TextView textView = holder.getView(R.id.bus_category_text);
        textView.setText(tag.floorName);
        return convertView;
    }
