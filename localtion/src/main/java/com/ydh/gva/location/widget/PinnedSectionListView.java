...
import com.ydh.gva.localtion.BuildConfig;
...
public class PinnedSectionListView extends ListView {
	...
	PinenedToTopListener pinenedToTopListener;
    ...
    public boolean isTitleColor = false;

	int currentVisiableIndex=-1;
	...
	private final OnScrollListener mOnScrollListener = new OnScrollListener() {
		...
		public void onScroll(AbsListView view, int firstVisibleItem,
			...
			if (isFirstVisibleItemSection) {
				currentVisiableIndex=firstVisibleItem;
				if( null != pinenedToTopListener){
					pinenedToTopListener.firstVisibleItemSection(currentVisiableIndex,false);
				}
				...
				if(firstVisibleItem < currentVisiableIndex){
					if( null != pinenedToTopListener){
						pinenedToTopListener.firstVisibleItemSection(currentVisiableIndex,true);
					}
				}
	...
	public interface PinenedToTopListener {
		void firstVisibleItemSection(int firstPosition, boolean isScrollUp);
	}

	public void setPinenedToTopListener(PinenedToTopListener l){
		pinenedToTopListener=l;
	}
