package gva.ydh.com.widgetlibrary;
 ...
 */
public class ElasticScrollView extends FrameLayout implements OnTouchListener {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (getChildCount() > 0) {
            ...
            if (child.getMeasuredHeight() < height) {
                ...
                int childHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(height, View.MeasureSpec.EXACTLY);
    ...
    protected void measureChildWithMargins(View child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec,
        ...
        final int childHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(lp.topMargin + lp.bottomMargin, View.MeasureSpec.UNSPECIFIED);
